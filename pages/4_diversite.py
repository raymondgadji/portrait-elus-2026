...
maires_diversite = pd.DataFrame([
    # Élus au 1er tour — liens avec Afrique subsaharienne
    {
        ...
        "Profil"           : "Élue sans étiquette. Liste \"Nouveau Souffle pour Saint-Mammès\".",
    ...
    },
    {
        ...
        "Profil"           : "Liste unique — 100% des suffrages exprimés. Pour Yèbles, une dynamique renforcée.",
    ...
    },
    {
        ...
        "Profil"           : "Élu écologiste. Liste \"L'Île Commune\".",
    ...
    },
    {
        ...
        "Score (%)"        : 61.25,
        "Origine (presse)" : "Togo",
        "Profil"           : "Élu divers droite. Liste \"Continuons Ensemble Plus Forts\".",
    ...
    },
    {
        ...
        "Score (%)"        : 50.49,
        "Origine (presse)" : "Maghreb (présumé, presse)",
        "Profil"           : "Député LFI. L'emporte avec seulement 104 voix d'avance (50,49% des exprimés).",
    ...
    },
    {
        ...
        "Profil"           : "Député LFI. Devance la maire sortante Michèle Picard "
                             "avec seulement 25 voix d'écart (34,11% des exprimés — scrutin proportionnel).",
